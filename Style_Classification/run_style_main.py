...
'''
Gets the accuracy of the min distance hinge feature vector classifier for Style
'''
...
if __name__ == '__main__':
    ...
    #training path
    style_base_path = '/home/jan/PycharmProjects/HandwritingRecog/data/train_test_morph/'
    ...
    # get accuracy of either the SVM or the hinge feature classifier
    get_acc_SVM(dataset_train, dataset_test)
